...
image_path = os.path.join(parent_dir,r"dataset\car_image.png")
csv_path = os.path.join(parent_dir,r"dataset\cleaned_car_price_csv.csv")
model_path_a = os.path.join(parent_dir,r"code\saved_model_for_car_price.pkl")
print("-"*36)
